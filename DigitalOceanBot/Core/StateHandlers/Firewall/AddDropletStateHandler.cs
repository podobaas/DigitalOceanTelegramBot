...
{
    [BotStateHandler(BotStateType.FirewallUpdateWaitingEnterAddDroplet)]
    public sealed class AddDropletStateHandler: IBotStateHandler
    {
        private readonly ITelegramBotClient _telegramBotClient;
        private readonly IDigitalOceanClient _digitalOceanClient;
        private readonly StorageService _storageService;

        public AddDropletStateHandler(
        ...
        public async Task ExecuteHandlerAsync(Message message)
        {
            ...
            if (isNumber)
            {
                ...
                await _digitalOceanClient.Firewalls.AddDroplets(firewallId, new FirewallDroplets
                {
