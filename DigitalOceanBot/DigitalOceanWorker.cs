...
namespace DigitalOceanBot
{
    internal sealed class DigitalOceanWorker : IHostedService
    {
        ...
        private async void OnCallbackQuery(object sender, CallbackQueryEventArgs e)
        {
            ...
            {
                await _botCommandResolver.StartCallbackQueryAsync(e.CallbackQuery.Message.Chat.Id, e.CallbackQuery.Message.MessageId, e.CallbackQuery.Id, e.CallbackQuery.Data);
            }
        }
